...
namespace ECM.Controllers
{
    ...
    public class BaseCharacterController : MonoBehaviour
    {
        ...
        public CharacterMovement playerCharacter;
        /// <summary>
        /// 
        /// </summary>
        /// 
        ...
        [SerializeField]
        protected float _maxMidAirJumps = 1;
        ...
        /// <summary>
        /// Should saved velocity (when item == true) be restored on resume (when item == false)?
        ...
        */
        ...
        {
            // Cache components
            if (playerCharacter != null) movement ??= playerCharacter;
